    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          'Privacy Policy',
          style:
              GoogleFonts.anekLatin(fontSize: 17, fontWeight: FontWeight.bold),
        ),
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildText(
                  'Privacy Policy', Colors.blue, 18, FontWeight.bold),
              const SizedBox(
                height: 10,
              ),
              _buildText(
...
Widget _buildText(
  ...
  return Text(
    text,
    style: TextStyle(
        color: color, fontSize: fontSize, fontWeight: fontWeight,fontFamily: 'Lato'),
  );
}
