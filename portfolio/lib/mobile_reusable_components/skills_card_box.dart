  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          Center(child: Text(heading,textAlign: TextAlign.center,style: tSubheadingTextStyle.copyWith(color: kAppBarDarkColor,fontWeight: FontWeight.bold,fontSize: 20,))),
          Center(
            child: Wrap(
