              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text('Feb 2024',style: tBodyTextStyle,),
                  ),
                ),
                Text('Scopus Migration',style: tSubheadingTextStyle.copyWith(color: kAppBarDarkColor,fontSize: 18),),
                GestureDetector(
                  onTap:openPublicationPdf,
                    child: Text(
                      'Click Here To View Article',
                      style: tSubheadingTextStyle.copyWith(color: kAppBarDarkColor,fontSize: 15,decoration: TextDecoration.underline),
